...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function getRecommendation(e) {
        ...
        // Get recommendation
        const results = RecommendationEngine.getRecommendation(merchant, category, amount);
        ...
        displayRecommendation(results, amount);
    }
    ...
    function showSaveTransactionForm() {
        ...
        // Set default card to best recommendation
        const bestCardId = currentRecommendation.results[0].card.id;
        form.elements['cardId'].value = bestCardId;
